...
public class ManagerOrdersReportController implements Initializable {
    ...
    private Label Q4Lbl; // Value injected by FXMLLoader
	    ...
	    {	
	    	 if((storeNameTxt1.getText().contentEquals("LilacHaifa") == true ||
	    		 ...
	    		 LilacApp.client.accept("get ord " + managerLbl.getText() + " " + storeNameTxt1.getText()
	  	             ...
	  	             if(response.contentEquals("Unsuccessful Orders Comparison") == true)
	  	             {
	  	             ...
	  	             else
	  	             {
	  	            	String[] temp = response.trim().split("\\,");
		  	             ...
		  	             result1Lbl.setText("month1 : " + temp[0]);
		  	             result2Lbl.setText("month2 : " + temp[1]);
	  	             }
	  	   	  }
	  	       else
	  	       {
	    ...
	    {   
	        if(storeNameTxt.getText().contentEquals("LilacHaifa") == true ||
	           ...
	           storeNameTxt.getText().contentEquals("All") == true)
	   	    {
	        	...
	        	LilacApp.client.accept("get histOrders " + managerLbl.getText() + " " + storeNameTxt.getText());
	             String response = LilacApp.client.getResponse();
	             
	             
	             if(response.contentEquals("Unsuccessful Orders Histogram") == true)
  	             {
  	            	checkTxt.setText("Error! Manager does not have the permission for this action"); 
  	             }
  	             else
